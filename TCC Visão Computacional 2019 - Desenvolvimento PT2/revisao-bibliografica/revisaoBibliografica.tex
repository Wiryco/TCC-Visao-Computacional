...
\input{./revisao-bibliografica/futebolAmericano.tex}
\input{./revisao-bibliografica/visaoComputacional.tex}
\input{./revisao-bibliografica/imagemCap.tex}
\input{./revisao-bibliografica/imagemProc.tex}
\input{./revisao-bibliografica/segmentacao.tex}
\input{./revisao-bibliografica/histograma.tex}
\input{./revisao-bibliografica/classificacao-imagens.tex}
\input{./revisao-bibliografica/similaridade.tex}
\input{revisao-bibliografica/reconhecimentoFacial.tex}
\input{revisao-bibliografica/ferramentas_desenvolvimento.tex}
\input{revisao-bibliografica/metodologiaAgil.tex}
%\input{./revisao-bibliografica/modelo.tex}
%\input{./revisao-bibliografica/desenvolvimento.tex}